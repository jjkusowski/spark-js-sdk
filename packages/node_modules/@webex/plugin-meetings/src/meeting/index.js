  ...
  join(options = {}) {
    ...
    return MeetingUtil.joinMeeting(this)
      .then((response) => {
        ...
        }).then((shareStream) => Media.getLocalMedia({
          sendShare: mediaDirection.sendShare // TODO: check share streams if true
        }).then((localStream) => [localStream, shareStream]));
      })
      .catch((err) => {
      ...
      .then(() =>
        this.roap
          .sendRoapMediaRequest({
            sdps: [this.mediaPeerConnection.sdp, this.sharePeerConnection.sdp],
